 ...
 <head> 
     ...
     <title>GRIP Banking System | Customer Details</title>
...
<div class="container-customer">
    ...
    <table>
        ...
        <?php
            $conn = mysqli_connect("localhost", "", "", "banksystem",3307);
            // Check connection
 ...
 <div class="footer">
     ...
     <div class="footer-center">
         <p class="footer-company-name">© GRIP Banking System 2024 | Designed by Manasa Papunuka</p>          
     </div>		
 </div>
 </footer>	
 <!--end footer-->
